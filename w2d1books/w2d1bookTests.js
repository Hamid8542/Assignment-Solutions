...
const myExports = require("./w2d1book.js");  //with node need the name of your file with your functions here
...
describe("library", function () {
   ...
   const ids = [1254,4264, 3245];
    ...
    it("addbook", function () {
        const newBook = {title: "Fiker Eske Mekaber", author: "Hadis Alemayeh", libraryID: 2274};
        ids.push(2274);
        assert.deepEqual(addBook(newBook), newBook);
        assert.deepEqual(addBook(  "Fiker Eske Mekaber","Hadis Alemayeh",2274), newBook);
        assert.deepEqual(findIDs(), ids);
    });
